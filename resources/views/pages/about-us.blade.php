                    ...
                    <div class="col-md-3 col-6 mb-md-4 mb-3 d-flex justify-content-center p-0">
                        <div class="card card-custom" onclick="location.href='{{ route('laserTag') }}#birthday'">
                            <div class="card-body d-flex flex-column justify-content-center">
                                ...
                                <h5 class="card-title text-center">День Народження</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 mb-md-4 mb-3 d-flex justify-content-center p-0">
    ...
    <section id="customCarousel" class="py-5">
        <div id="coverflow" class="py-5">
            <ul class="flip-items">
                ...
                <li data-flip-title="Світлина">
                    <img src="{{ asset('storage/images/carousel/img-13.png') }}" alt="Світлина 13">
                </li>
                <li data-flip-title="Світлина">
            ...
            <div class="py-4 py-md-5">
                <div class="row">
                    <div class="col-md-6 d-flex flex-column mb-4 order-md-1 order-3">
                        <div>
                            <p class="text-subtitle">Ігрова зона «Караван» розташована на лівому березі міста Дніпро, в
                                районі гіпермаркету Караван. Ігровий майданчик&nbsp;— це величезний бетонний комплекс
                                площею 10&nbsp;000&nbsp;кв.&nbsp;метрів та 3&nbsp;000&nbsp;кв.&nbsp;м відкритої площадки&nbsp;—
                                зеленої зони.<br>Територія комплексу не має поверхів і побудована в один ярус,
                                знаходиться під дахом; це свого роду бетонні джунглі, які дозволяють нам не сильно
                                залежати від погодних умов.<br>Під час літньої спеки під дахом завжди приємна прохолода,
                                а під час дощу або снігу вам на голову нічого не капатиме.</p>
                        </div>
                        <div>
